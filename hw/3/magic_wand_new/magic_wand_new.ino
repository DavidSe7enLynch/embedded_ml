...
void ReadAccelerometerAndGyroscope(int* new_accelerometer_samples,
  ...
  *new_gyroscope_samples = 0;
  ...
  while (IMU.accelerationAvailable()) {
    ...
    //   break;
    // }
    IMU.readGyroscope(current_gyroscope_data[0], current_gyroscope_data[1], current_gyroscope_data[2]);
    *new_gyroscope_samples += 1;
    ...
    //   break;
    // }
    IMU.readAcceleration(current_acceleration_data[0], current_acceleration_data[1], current_acceleration_data[2]);
